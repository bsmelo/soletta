...
static struct sol_blob server_addr_dtls = {
    .type = &SOL_BLOB_TYPE_NO_FREE,
    .parent = NULL,
    .mem = (void *)"coap://localhost:5684",
    .size = sizeof("coap://localhost:5684") - 1,
    .refcnt = 1
};
...
main(int argc, char *argv[])
{
    ...
    client = sol_lwm2m_client_new(cli_name, NULL, NULL, objects,
        sec_mode != SOL_LWM2M_SECURITY_MODE_NO_SEC, &data_ctx);
